...
#define RPLDGK          29      /* GUILD room */
#define RRSCND          30      /* player can pledge/rescind in room */
...
#define PPLDGK          39      /* Pledged to a Guild */
/*  The PKNGDM is no longer used  */
#define PKNGDM          40      /* Pledge to princ */
...
#define PBESRK		51	/* Player is beserking */
...
#define MGUILD          31      /* monster belongs to a guild */
...
#define OPLDGK          29      /* guild item */
#define OBKSTA          30      /* object is a backstab weapon */
...
#define OHBREW          46      /* Herb brew Item */
#define OHNGST          47      /* Herb food  Item */
...
#define DL_CHARM	5	/* Daily charms / transmutes*/
...
/* WARNING: cant go past 44 for last time stuff */
...
#define			WIMPYVALUE carry[0] 
	/* NOTE: carry[1] and carry[2] are now used for bank balance */
	short		rom_num;
...
//	otag		*first_locker_obj; /* list of items in locker */
...
/* FILES3.C */
extern int write_obj_to_mem(char *buf, object *obj_ptr, char perm_only );
